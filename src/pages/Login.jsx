...
export default function Login({ onLogin }) {
  ...
  return (
    <div className={`flex flex-col relative overflow-hidden ${dark ? 'bg-dark-900 text-white' : 'bg-[#f5f5f7] text-gray-900'}`} style={{ height: '100dvh', paddingTop: 'env(safe-area-inset-top, 0px)', paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}>
      ...
      <div className="absolute right-5 z-20" style={{ top: 'calc(env(safe-area-inset-top, 0px) + 16px)' }}>
      ...
      {mode !== 'login' && (
        <div className="absolute left-5 z-20" style={{ top: 'calc(env(safe-area-inset-top, 0px) + 16px)' }}>
