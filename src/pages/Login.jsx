...
export default function Login({ onLogin }) {
  ...
  return (
    <div className={`flex flex-col relative overflow-hidden ${dark ? 'bg-dark-900 text-white' : 'bg-[#f5f5f7] text-gray-900'}`} style={{ height: '100dvh' }}>
      ...
      <div className="absolute right-5 z-20" style={{ top: '16px' }}>
      ...
      {mode !== 'login' && (
        <div className="absolute left-5 z-20" style={{ top: '16px' }}>
